...
//let systems = document.querySelectorAll('.IT_system');
//for(let IT_system of systems) {
//  IT_system.insertAdjacentHTML("afterbegin", '<button class="remove-button">[x]</button>');
//  IT_system.firstChild.onclick = () => IT_system.remove();
//}
